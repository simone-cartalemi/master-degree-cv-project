...
def main(input_folder: str, benchmarking_labels: bool = False, verbose: bool = False):
    ...
    output_folder = os.path.join(RESULTS_PATH, "speed", os.path.basename(os.path.dirname(input_folder)))
...
if __name__ == "__main__":
    ...
    main(args.input_folder_path, args.benchmark, args.verbose)
